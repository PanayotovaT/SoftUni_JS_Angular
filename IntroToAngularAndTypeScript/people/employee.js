...
var Senior = /** @class */ (function (_super) {
    ...
    function Senior() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.tasks = ["".concat(_this.name, " is working on a complicated task."), "".concat(_this.name, " is taking time off work"), "".concat(_this.name, " is supervising junior workers.")];
        return _this;
    }
...
var Manager = /** @class */ (function (_super) {
    ...
    function Manager() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.tasks = ["".concat(_this.name, " schedualed a meeting."), "".concat(_this.name, " is preparing quarterly report.")];
        return _this;
    }
